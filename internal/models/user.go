...
type userR struct {
	UsernameDocuments DocumentSlice `boil:"UsernameDocuments" json:"UsernameDocuments" toml:"UsernameDocuments" yaml:"UsernameDocuments"`
}
...
func (r *userR) GetUsernameDocuments() DocumentSlice {
	if r == nil {
		return nil
	}
	return r.UsernameDocuments
}
...
// UsernameDocuments retrieves all the document's Documents with an executor via username column.
func (o *User) UsernameDocuments(mods ...qm.QueryMod) documentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"main\".\"document\".\"username\"=?", o.Username),
	)

	return Documents(queryMods...)
}

// LoadUsernameDocuments allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUsernameDocuments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`main.document.username in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.UsernameDocuments = resultSlice
...
// AddUsernameDocuments adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UsernameDocuments.
// Sets related.R.UsernameUser appropriately.
func (o *User) AddUsernameDocuments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Document) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			UsernameDocuments: related,
		}
	} else {
		o.R.UsernameDocuments = append(o.R.UsernameDocuments, related...)
	}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"main\".\"user\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"main\".\"user\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, username string, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"main\".\"user\" where \"username\"=$1", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"main\".\"user\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"main\".\"user\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"main\".\"user\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"main\".\"user\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"main\".\"user\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"main\".\"user\" WHERE \"username\"=$1"
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"main\".\"user\" WHERE " +
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"main\".\"user\".* FROM \"main\".\"user\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, username string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"main\".\"user\" where \"username\"=$1 limit 1)"
